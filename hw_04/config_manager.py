...
class ConfigManager:
    ...
    def __enter__(self) -> Union[dict, list, str, int, float, bool, None, configparser.ConfigParser]:
...
config_file = "some.json"  # Замінити на шлях до вашого файлу
try:
    with ConfigManager(config_file, file_type="json") as manager:
        manager.update_person_phone("Іван", "+380967858321")
        print("Phone updated successfully.")

    # Після виходу з блоку `with`, можна працювати з даними в конфігурації
